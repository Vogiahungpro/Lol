...
local old_Lol = CoreGui:FindFirstChild('Lol')

if old_Lol then
    Debris:AddItem(old_Lol, 0)
end

if not isfolder("Lol") then
    makefolder("Lol")
end
...
local Config = setmetatable({
    save = function(self: any, file_name: any, config: any)
        local success_save, result = pcall(function()
            ...
            writefile('Lol/'..file_name..'.json', flags)
        end)
    ...
    load = function(self: any, file_name: any, config: any)
        local success_load, result = pcall(function()
            if not isfile('Lol/'..file_name..'.json') then
                self:save(file_name, config)
        
                return
            end

            local flags = readfile('Lol/'..file_name..'.json')
...
Container.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
Container.AnchorPoint = Vector2.new(0.5, 0.5)
Container.Name = 'Container'
Container.BackgroundTransparency = 0.2
Container.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
Container.Position = UDim2.new(0.5, 0, 0.5, 0)
Container.Size = UDim2.new(0, 0, 0, 0)
Container.Active = true
Container.BorderSizePixel = 0
Container.Parent = Lol
...
UIStroke.Color = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
...
Handler.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
Handler.Size = UDim2.new(0, 698, 0, 479)
Handler.BorderSizePixel = 0
Handler.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
...
Tabs.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
Tabs.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
...
ClientName.TextColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey for text
...
ClientName.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
ClientName.TextSize = 13
ClientName.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
ClientName.Parent = Handler

local UIGradient = Instance.new('UIGradient')
UIGradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(120, 180, 255)), -- Changed to light blue
    ColorSequenceKeypoint.new(1, Color3.fromRGB(80, 80, 80)) -- Changed to darker medium grey
}
...
Pin.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
Pin.Size = UDim2.new(0, 2, 0, 16)
Pin.BorderSizePixel = 0
Pin.BackgroundColor3 = Color3.fromRGB(120, 180, 255) -- Changed to light blue
Pin.Parent = Handler
...
Icon.ImageColor3 = Color3.fromRGB(120, 180, 255) -- Changed to light blue
Icon.ScaleType = Enum.ScaleType.Fit
Icon.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
...
Icon.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
Icon.Parent = Handler
...
Divider.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
Divider.Size = UDim2.new(0, 1, 0, 479)
Divider.BorderSizePixel = 0
Divider.BackgroundColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
...
Minimize.TextColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey
Minimize.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
Minimize.Text = ''
...
Minimize.BackgroundColor3 = Color3.fromRGB(120, 180, 255) -- Changed to light blue
...
UIScale.Parent = Container
    ...
    function self:load()
        ...
        for _, object in Lol:GetDescendants() do
        ...
        for index, object in Tabs:GetChildren() do
            ...
            if object == tab then
                if object.BackgroundTransparency ~= 0.5 then
                    ...
                    TextColor3 = Color3.fromRGB(120, 180, 255) -- Changed to light blue
                }):Play()
                ...
                TweenService:Create(object.Icon, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                    ...
                    ImageColor3 = Color3.fromRGB(120, 180, 255) -- Changed to light blue
                }):Play()
                end
            ...
            if object.BackgroundTransparency ~= 1 then
                ...
                TweenService:Create(object.TextLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                    ...
                    TextColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey
                }):Play()
                ...
                TweenService:Create(object.Icon, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                    ...
                    ImageColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey
                }):Play()
            end
        end
    end
    ...
    function self:create_tab(title: string, icon: string)
        ...
        Tab.TextColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey
        Tab.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
        Tab.Text = ''
        ...
        Tab.TextSize = 14
        Tab.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
        Tab.Parent = Tabs
        ...
        TextLabel.TextColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey
        ...
        TextLabel.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
        TextLabel.TextSize = 13
        TextLabel.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
        TextLabel.Parent = Tab
        
        local UIGradient = Instance.new('UIGradient')
        UIGradient.Color = ColorSequence.new{
            ColorSequenceKeypoint.new(0, Color3.fromRGB(120, 180, 255)), -- Changed to light blue
            ColorSequenceKeypoint.new(0.7, Color3.fromRGB(150, 150, 150)), -- Changed to medium-light grey
            ColorSequenceKeypoint.new(1, Color3.fromRGB(80, 80, 80)) -- Changed to darker medium grey
        }
...
Module.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
Module.BorderSizePixel = 0
Module.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
...
ModuleName.TextColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey
...
Description.TextColor3 = Color3.fromRGB(150, 150, 150) -- Changed to medium-light grey
...
Toggle.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
...
Circle.BackgroundColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
...
Keybind.BackgroundColor3 = Color3.fromRGB(120, 180, 255) -- Changed to light blue
...
Divider1.BackgroundColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
...
Options.Parent = Module
            ...
            function ModuleManager:change_state(state: boolean)
                ...
                if self._state then
                    ...
                    TweenService:Create(Toggle, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(120, 180, 255) -- Changed to light blue
                    }):Play()
                    ...
                    TweenService:Create(Toggle, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
                    }):Play()

                    TweenService:Create(Circle, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(100, 100, 100), -- Changed to medium grey
            ...
            function ModuleManager:create_paragraph(settings: any)
                ...
                Paragraph.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
                ...
                local Title = Instance.new('TextLabel')
                Title.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.SemiBold, Enum.FontStyle.Normal)
                Title.TextColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey
                ...
                local Body = Instance.new('TextLabel')
                Body.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.Regular, Enum.FontStyle.Normal)
                Body.TextColor3 = Color3.fromRGB(150, 150, 150) -- Changed to medium-light grey
                
                if not settings.rich then
                    Body.Text = settings.text or "Skibidi"
                else
                    Body.RichText = true
                    Body.Text = settings.richtext or "<font color='rgb(120,180,255)'>Lol</font> user" -- Changed to light blue
                end
                ...
                Paragraph.MouseEnter:Connect(function()
                    TweenService:Create(Paragraph, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(100, 150, 255) -- Changed to slightly darker light blue
                    }):Play()
                end)
            ...
            function ModuleManager:create_text(settings: any)
                ...
                TextFrame.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Changed to darker medium grey
                ...
                function TextManager:Set(new_settings)
                    if not new_settings.rich then
                        ...
                        Body.RichText = true
                        Body.Text = new_settings.richtext or "<font color='rgb(255,0,0)'>Lol</font> user" -- Default rich text
                    end
                end;
            ...
            function ModuleManager:create_textbox(settings: any)
                ...
                Label.TextColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey
                ...
                Textbox.TextColor3 = Color3.fromRGB(180, 180, 180) -- Changed to light grey
                Textbox.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Changed to medium grey
                ...
                Textbox.TextSize = 10
                Textbox.BackgroundColor3 = Color3.fromRGB(120, 180, 255) -- Changed to light blue
